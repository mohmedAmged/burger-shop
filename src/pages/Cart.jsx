                        ...
                        <div className="mx-auto mt-6 max-w-4xl flex-1 space-y-6 lg:mt-0 lg:w-full">
                                ...
                                <div className="space-y-4">
                                    <div className="space-y-2">
                                        ...
                                        <dl className="flex items-center justify-between gap-4">
                                            ...
                                            <dd className="text-base font-medium text-green-500">-{savings || 0} EGP </dd>
                                        </dl>
                                    ...
                                    <dl className="flex items-center justify-between gap-4 border-t border-yellow/20 pt-2">
                                        ...
                                        <dd className="text-base font-bold text-yellow">{appliedVoucher ? totalPriceAfterCode : totalPrice} EGP</dd>
                                    </dl>
                                </div>
                            ...
                            <div className="space-y-4 rounded-3xl border border-yellow/20 bg-black/50 p-6">
                                {appliedVoucher ? (
                                    <div className="space-y-4">
                                        <div>
                                            <label className="mb-2 block text-sm font-medium text-white"> Applied Voucher </label>
                                            <div className="flex items-center justify-between rounded-lg border border-green-500/50 bg-green-500/10 p-3">
                                                <span className="font-modern-negra text-green-400">{appliedVoucher.code}</span>
                                                <button
                                                    onClick={() => {
                                                        removeVoucher();
                                                        setVoucher('');
                                            ...
                                            <p className="mt-2 text-sm text-green-400">
                                                You saved {savings} EGP with this voucher!
                                            </p>
                                        </div>
                                    </div>
                                ) : (
                                    <form className="space-y-4" onSubmit={handleApplyVoucher}>
                                        <div>
                                            ...
                                            <input
                                                ...
                                                type="text"
                                                id="voucher"
                                                className="block w-full rounded-lg border border-yellow/20 bg-transparent p-2.5 text-sm text-white placeholder:text-white/50 focus:border-yellow/30 focus:ring-yellow/30"
                                                placeholder=""
                                                required />
                                        </div>
                                        <button type="submit" className="flex w-full items-center justify-center rounded-lg bg-color-yellow px-5 py-2.5 text-sm font-bold text-black hover:opacity-90 cursor-pointer">Apply Code</button>
                                    </form>
                                )}
                            </div>
                        </div>
