        ...
        <div className='min-h-screen py-28 2xl:px-0 px-5 container mx-auto radial-gradient'>
            <div className=" flex items-center justify-center p-4 ">
                <div className="max-w-md w-full border border-yellow/20 bg-black/50 rounded-3xl shadow-lg p-8 ">
                    <h2 className="text-3xl font-modern-negra text-white mb-6 text-center sm:text-4xl">Sign Up</h2>

                    <form className="space-y-4" onSubmit={handleSubmit}>
                        <div>
                            <label className="block text-sm font-medium color-white mb-1">name</label>
                            <input
                                type="text"
                                name="name"
                                value={formData?.name}
                        ...
                        <div>
                            <label className="block text-sm font-medium color-white mb-1">phone</label>
                            <input
                                type="tel"
                                name="phone"
                        ...
                        <button
                            type="submit"
                            disabled={loading}
                            className="flex w-full items-center justify-center rounded-lg bg-color-yellow px-6 py-3 text-lg font-bold text-black hover:opacity-90 cursor-pointer mt-4">
                    ...
                    <div className="mt-6 text-center text-sm text-white">
                        ...
                        <a href="/sign-in" className="text-white hover:text-yellow font-bold">Sign in</a>
                    </div>
                </div>
            </div>
        </div>
